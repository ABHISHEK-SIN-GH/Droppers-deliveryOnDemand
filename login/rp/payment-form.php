            ...
            <form action="pay.php" method="post" style="padding: 25px;">
                ...
                <div class="row-f">
                    <div class="col-f">
                        ...
                        <input type="text" id="fname" name="customername" placeholder="Enter Full Name" required>
                        <label for="email"><i class="fa fa-envelope"></i> Email</label>
                        <input type="text" id="email" name="email" placeholder="Enter Email Address" required>
                        <label for="city"><i class="fa fa-mobile"></i> Mobile</label>
                        <input type="text" id="city" name="contactno" placeholder="Enter Mobile Number" required>
                        <label for="money"><i class="fa fa-money"></i> Amount</label>
                        <input type="text" id="amount" name="price" placeholder="Please Enter Amount" required>
